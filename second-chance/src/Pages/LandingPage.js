...
export const LandingPage = () => {
    return(
        <Hero>
            <LandingImage><img className='landingImg' src='https://images.unsplash.com/photo-1455165814004-1126a7199f9b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80' /></LandingImage>
